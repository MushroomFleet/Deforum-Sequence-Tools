<a target="_blank" href="https://colab.research.google.com/github/MushroomFleet/Deforum-Sequence-Tools/blob/main/Deforum_Sequence_ToolsV1.ipynb">
  <img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/>
</a>

# Deforum-Sequence-Tools
some tools to aid creation of Prompt Sequences and other Animation sequences for Stable Diffusion web ui

![alt text](https://github.com/MushroomFleet/Deforum-Sequence-Tools/blob/main/prompt-sequence.png?raw=true)
![alt text](https://github.com/MushroomFleet/Deforum-Sequence-Tools/blob/main/strength-modes.png?raw=true)
